# Contributing to Waypoint Plugin Examples
...
If you have found an issue with the main Waypoint project, please report it
over on the main [Waypoint project page](https://github.com/hashicorp/waypoint).
