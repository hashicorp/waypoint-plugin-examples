...
func (x *AccessInfo) Reset() {
	*x = AccessInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_registry_output_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccessInfo) Descriptor() ([]byte, []int) {
	return file_registry_output_proto_rawDescGZIP(), []int{1}
}
...
var file_registry_output_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x34, 0x0a, 0x0a, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x49,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x42, 0x50, 0x5a, 0x4e, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x61, 0x73, 0x68, 0x69, 0x63,
	0x6f, 0x72, 0x70, 0x2f, 0x77, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2d, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2f, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x73, 0x2f, 0x67, 0x6f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x5f, 0x66,
	0x69, 0x6e, 0x61, 0x6c, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x62, 0x06, 0x70,
...
var file_registry_output_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_registry_output_proto_goTypes = []interface{}{
	(*Artifact)(nil),   // 0: registry.Artifact
	(*AccessInfo)(nil), // 1: registry.AccessInfo
}
...
func file_registry_output_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_registry_output_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
